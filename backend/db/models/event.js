...
module.exports = (sequelize, DataTypes) => {
  ...
  Event.init({
    ...
    description: {type: DataTypes.STRING , allowNull: false , validate: {
      checkNull(val){
        if (!val){
    ...
    type: {type: DataTypes.STRING , allowNull: false , validate: {
      checkType(val){
    ...
    endDate: {type: DataTypes.DATE , allowNull: false , validate: {
       checkDate(val){
